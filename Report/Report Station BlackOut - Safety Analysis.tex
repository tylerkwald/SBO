...
\begin{itemize}
    \item \textbf{Filippo Dalmonego:} Methodology, Coding, Writing, Review, Supervision.
    \item \textbf{Tyler Ewald:} Methodology, Coding, Writing, Editing, Supervision.
    \item \textbf{Riccardo Fasano:} Methodology, Writing, Coding, Editing, Supervision.
    \item \textbf{Francesco Qualizza:} Methodology, Supervision, Writing, Review \& Editing.
\end{itemize}
