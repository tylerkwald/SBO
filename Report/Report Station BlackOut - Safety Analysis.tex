...
it used to extract the heat coming from the core where no AC powered system is available. A natural circulation
...
\noindent In this section we are going to perform two additional 
calculations, in which the EOPs's unavailability (one for each calculation) is assumed. 
This analysis in necessary in order to verify that the plant is able to respond to this kinds of scenarios 
