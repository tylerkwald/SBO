...
This number is aligned with the general order of magnitude in plant safety and similar to the one analyzed down by the NRC, in for the Surry NPP \cite{Surry}, the total core damage frequency from all SBO initiating events (SBO+Battery Depletion, SBO+SBLOCA, SBO+AFWfail + SBO+SORV + ...) is $2.7664\cdot10^{-5}$ pry. 
...
the base-case transient (Section~\ref{sec:base_case}); second, the
