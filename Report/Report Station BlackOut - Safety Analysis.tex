...
Similarly to the large leak condition, the Restore AC probability is no subject to equation~\ref{eq:1}. So the probability of sucess is:
\begin{equation}
    P(R) = 0.091 \nonumber
\end{equation}
