...
After the steady-state verification, the SBO base case is studied. This transient is the reference accident scenario for the project and is used to understand the plant behavior during loss of power conditions before introducing any additional safety-system modifications.
